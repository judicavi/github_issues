...
A small project to fetch and display react's issues in git repo.

This project was bootstrapped with [Create React App] (https://github.com/facebook/create-react-app).

To find the issues was used [Oktokit] to call the GitHub API (https://www.npmjs.com/package/@octokit/rest)
